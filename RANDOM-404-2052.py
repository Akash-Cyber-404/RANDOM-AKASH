...
princp=[]
try:
	prox= requests.get('https://github.com/Akash-Cyber-404/RANDOM-AKASH/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Akash-Cyber-404/RANDOM-AKASH').text
		ua=open('.bbnew.txt','w')
